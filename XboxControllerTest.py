...
while gamepad.isConnected():
    ...
    if eventType == 'BUTTON':
        ...
        if (control == 'RIGHT-Y') and (value == 0):
            print('RIGHT-Y zero', value)
        elif (control == 'RIGHT-Y') and (value > 0.1):
            print('RIGHT-Y positive', value)
        elif (control == 'RIGHT-Y') and (value < -0.1):
            print('RIGHT-Y negative', value)
        elif (control == 'LEFT-X') and (value == 0):
            print('LEFT-X zero', value)
        elif (control == 'LEFT-X') and (value > 0.1):
            print('LEFT-X positive', value)
        elif (control == 'LEFT-X') and (value < -0.1):
            print('LEFT-X negative', value)
